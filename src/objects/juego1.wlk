...
const partida1 = new Partida(siguientePartida = partida2, imagenPartida = "imagen", imagenPared = "imagenParedxD", personaje = cabeza, imagenManzana = "imagenManzana", objetivoManzanas = 10, 
